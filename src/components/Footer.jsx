...
const Footer = () => {
    return (
        <div className="bg-zinc-50 shadow-red-400 shadow-[0px_-2px_2px_0px] flex justify-evenly md:flex-nowrap flex-wrap">
            <img src="/images/website_photo.jpg" alt={"photo of me"} className="w-1/5 h-1/5 aspect-square m-16 content-center shadow-lg shadow-red-200 rounded-4xl "></img>
            <h2 className="text-center font-serif font-bold text-2xl content-center w-3/5 outline-1">
